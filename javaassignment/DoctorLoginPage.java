...
public class DoctorLoginPage extends javax.swing.JFrame {
    ...
    public DoctorLoginPage(String role) {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(158, 163, 176));
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        String password = passwordField.getText().trim(); // Use getPassword() for password fields

        boolean loginSuccessful = false;

        try (BufferedReader br = new BufferedReader(new FileReader("src\\textfiles\\doctor.txt"))) {
            String line;
            while ((line = br.readLine()) != null) {
                String[] values = line.split(", ");
                if (values.length >= 3 && values[1].equals(email) && values[2].equals(password)) {
